...
(def RevisionApiParams [:map
                        ...
                        [:revision-id :datahost/slug-string]
                        [:title {:optional true} :string]
                        [:description {:optional true} :string]])

(defn normalise-revision [base-entity api-params jsonld-doc]
  (let [{:keys [release-slug revision-id]} api-params
...
(defn- create-revision [base-entity api-params jsonld-doc]
  (log/info "Creating revision "
            (str/join "/" [(:series-slug api-params) (:release-slug api-params) (:revision-id api-params)]))
  (normalise-revision base-entity api-params jsonld-doc))

(defn insert-revision [db api-params jsonld-doc]
  (let [{:keys [series-slug release-slug revision-id]} api-params
      ...
      (assoc db revision-key (create-revision base-entity api-params jsonld-doc))))
